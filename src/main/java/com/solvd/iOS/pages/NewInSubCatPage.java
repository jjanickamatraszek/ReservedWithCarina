...
import com.solvd.iOS.components.ProductFilters;
...
public class NewInSubCatPage extends NewInSubCatPageBase {
    ...
    @FindBy(xpath = ".//*[@id='categoryProducts']//article")
    private List<ExtendedWebElement> products;

    @FindBy(css = "#cookiebanner")
    private CookieDialog cookieDialog;

    @FindBy(xpath = ".//*[@id='categoryFilters']")
    ...
    public ProductFiltersBase getProductFilters() {
        waitUntil(ExpectedConditions.visibilityOf(productFiltersBtn.getElement()), 10);
        productFiltersBtn.clickByJs();
